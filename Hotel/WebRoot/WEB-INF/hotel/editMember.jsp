...
<html>
  <head> 
    <title>My JSP 'editMember.jsp' starting page</title>
 ...
 <div id="container">
  ...
  <div id="content" style="width:98%;position:relative">
    ...
    <div class="subcontent">
      <form action="${pageContext.request.contextPath }/Modify.do">        
        <fieldset>
          <legend>联系信息</legend>
          <div>
          	<input type="hidden" name="member.id" id="id" value="${member.id}"/>
            <label for="name">联系人</label>
            <input type="text" name="member.name" id="name" value="${member.name}" onblur="checkName();" onfocus="onf('name');"/><span id="nameMessage"></span>
          </div>
          <div>
            <label for="phone">联系电话</label>
            <input type="text" name="member.phone" id="phone" value="${member.phone}" onblur="checkPhone();" onfocus="onf('phone');"/><span id="phoneMessage"></span>
          </div>
          <div>
            <label for="email">电子邮件</label>
            <input type="text" name="member.email" id="email" value="${member.email}" onblur="checkEmail();" onfocus="onf('email');"/><span id="emailMessage"></span>
          </div>
        </fieldset>
